...
import { faEye, faImage, faLongArrowAltRight, faPhone, faHotel, faAngleLeft, faAngleRight } from '@fortawesome/free-solid-svg-icons';
  ...
  ngOnInit(): void {
    ...
    if (this.route.snapshot.data.estateList) {
      ...
      if (isPlatformServer(this.platformId)) {
        this.seo.setTitle('Homestay - Homestay hạ long - Homestay quảng ninh');
